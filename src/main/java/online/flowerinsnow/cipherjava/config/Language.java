...
public class Language extends ConfigurationRoot {
    ...
    public static class Error extends ConfigurationRoot {
        ...
        public static class IO extends ConfigurationRoot {
            ...
            public static final ConfiguredValue<String> UNABLE_WRITE = ConfiguredValue.of(String.class, "<f:red>An error occurred while writing to file <f:yellow>%s<f:red>: <f:yellow>%s<c:reset>");
        }

        public static class Key extends ConfigurationRoot {
            public static final ConfiguredValue<String> KEY_INVALID = ConfiguredValue.of(String.class, "<f:red>Key file<f:yellow>%s<f:red> is invalid.<c:reset>");
            public static final ConfiguredValue<String> KEY_FILE_INVALID_BASE64 = ConfiguredValue.of(String.class, "<f:red>Key file<f:yellow>%s<f:red> base64 is invalid.<c:reset>");
            public static final ConfiguredValue<String> KEY_FILE_INVALID_HEX = ConfiguredValue.of(String.class, "<f:red>Key file<f:yellow>%s<f:red> HEX is invalid.<c:reset>");
            public static final ConfiguredValue<String> KEY_FILE_INVALID = ConfiguredValue.of(String.class, "<f:red>Key file<f:yellow>%s<f:red> is invalid.<c:reset>");
        }
    }
